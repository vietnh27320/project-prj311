...
//            int type = NumberHelper.getValidateId(request.getParameter("type"));
            List<Product> resultSearch = new ProductDao().search(text);
            ...
            List<Image> listImagecoverMapping = new ImgDao().listImageCoverMapping(listImgCover, resultSearch);
            request.setAttribute("results", resultSearch);
