...
@WebServlet(name = "GetProDetail", urlPatterns = {"/GetProDetail"})
public class GetProDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (productId == -1) {
                ...
                List<Image> listImage = new ImgDao().getAllByProID(productId);
                if (product == null) {
                    response.sendRedirect("error.jsp");
                } else {
